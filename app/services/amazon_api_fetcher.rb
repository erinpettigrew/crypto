class AmazonAPIFetcher
  ...
  def by_asin(asin)
    params = {
      ...
      "AWSAccessKeyId" => ENV["AWS_API_ACCESS_KEY_ID"],
      "AssociateTag" => ENV["AWS_API_ASSOCIATES_TAG"],
      "ItemId" => asin,
      "IdType" => "ASIN",
  ...
  def generate_request_url(params)
    ...
    signature = Base64.encode64(OpenSSL::HMAC.digest(OpenSSL::Digest.new('sha256'), ENV["AWS_API_SECRET_KEY"], string_to_sign)).strip()
